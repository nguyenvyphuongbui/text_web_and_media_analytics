...
if __name__ == "__main__":
    ...
    def insert_pre_and_map(result_df, pre, map_value, column_name):
        ...
        return result_df
    result_df = insert_pre_and_map(result_df, bm25, avg_bm25, 'BM25')
    result_df = insert_pre_and_map(result_df, jm, avg_jm, 'JM_LM')
    result_df = insert_pre_and_map(result_df, prm, avg_prm, 'MY_PRM')
    print(result_df)
