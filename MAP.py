...
if __name__ == "__main__":
    ...
    def insert_pre_and_map(result_df, pre, map_value, column_name):
        ...
        return result_df
    result_df = insert_pre_and_map(result_df, pre_bm25, map_bm25, 'BM25')
    result_df = insert_pre_and_map(result_df, pre_JM, map_JM, 'JM_LM')
    result_df = insert_pre_and_map(result_df, pre_PRM, map_PRM, 'MY_PRM')
    print(result_df)
